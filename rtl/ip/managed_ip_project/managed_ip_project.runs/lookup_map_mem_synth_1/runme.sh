...
HD_PWD='/home/lane/work/ubixum/prj/xenecor/src/lib/imager/rtl/ip/managed_ip_project/managed_ip_project.runs/lookup_map_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lookup_map_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lookup_map_mem.tcl
