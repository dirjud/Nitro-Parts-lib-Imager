...
HD_PWD='/home/lane/work/ubixum/prj/xenecor/src/lib/imager/rtl/ip/managed_ip_project/managed_ip_project.runs/rotate2rams_yuv420_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rotate2rams_yuv420_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rotate2rams_yuv420_fifo.tcl
