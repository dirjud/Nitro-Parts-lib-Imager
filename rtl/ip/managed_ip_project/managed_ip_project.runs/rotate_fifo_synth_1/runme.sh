...
HD_PWD='/home/lane/work/ubixum/prj/xenecor/src/lib/imager/rtl/ip/managed_ip_project/managed_ip_project.runs/rotate_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rotate_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rotate_fifo.tcl
